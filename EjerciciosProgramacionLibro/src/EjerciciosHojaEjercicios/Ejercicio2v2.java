...
public class Ejercicio2v2 {
    public static void main(String[] args) {
        ...
        final int NUM_MAX_INT = 7;
        
        System.out.println("Dime un numero del 1 al 1000 a ver si aciertas: ");
        numJugador = sc.nextInt();
               
        while (numJugador != numMaquina && numJugador != -1 && contFallos != NUM_MAX_INT -1){
        ...
        } else if (contFallos == NUM_MAX_INT -1) {
            System.out.println("Has fallado los " + NUM_MAX_INT + "intentos reinicia el programa para volver a jugar");
